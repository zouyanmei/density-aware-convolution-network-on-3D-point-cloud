...
def get_model(point_cloud, is_training, num_class, bn_decay=None):
    ...
    l3_points = pointnet_fp_module_new(l3_xyz, l4_xyz, l3_points, l4_points, [256,256], 8, is_training, bn_decay, scope='fa_layer1')
    l2_points = pointnet_fp_module_new(l2_xyz, l3_xyz, l2_points, l3_points, [256,256], 4, is_training, bn_decay, scope='fa_layer2')
