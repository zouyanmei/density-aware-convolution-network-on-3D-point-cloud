...
parser.add_argument('--ply_path', default='/home/vision/ware/zym/data/scannet/scans', help='ply path from original Scannet')
...
def evaluate(num_votes):
    with tf.device('/gpu:'+str(GPU_INDEX)):
        ...
        pred, predn, end_points = MODEL.get_model(pointclouds_pl, is_training_pl, NUM_CLASSES, BANDWIDTH)
