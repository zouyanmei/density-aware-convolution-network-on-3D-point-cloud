...
parser.add_argument('--room_data_filelist', default="/home/vision/ware/zym/lab/code/s3dis/pointnet2/sem_seg/meta/area6_data_label.txt", help='TXT filename, filelist, each line is a test room data label file.')
...
ROOM_PATH_LIST = [os.path.join("/home/vision/ware/zym/data",line.rstrip()) for line in open(FLAGS.room_data_filelist)]
NUM_CLASSES = 13
...
def evaluate():
    ...
    with tf.device('/gpu:'+str(GPU_INDEX)):
        ...
        # simple model
        pred, pred_new = get_model(pointclouds_pl, is_training_pl,NUM_CLASSES)
        ...
        for b in range(BATCH_SIZE):
            ...
            for i in range(NUM_POINT):
                ...
                if FLAGS.visu:
                    ...
                    fout_gt.write('v %d %d %d\n' % ( color_gt[0], color_gt[1], color_gt[2]))
                fout_data_label.write('%f %d\n' % ( pred_val[b,i,pred[i]], pred[i]))
