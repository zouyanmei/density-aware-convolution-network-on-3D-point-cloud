...
parser.add_argument('--data', default='/home/vision/ware/zym/data/SemanticKITTI/dataset/', help='Root for dataset')
parser.add_argument('--model', default='pointnet2_sem_seg', help='Model name [default: model]')
parser.add_argument('--batch_size', type=int, default=48, help='Batch Size during evaluation [default: 6]')
